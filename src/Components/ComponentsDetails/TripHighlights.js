...
function TripHighlights({ Highlights }) {
  ...
  return (
    <div className="container mb-10 mt-5 w-full px-5">
      ...
      <ul className="grid grid-flow-row-dense grid-cols-2 sm:grid-cols-3 md:grid-cols-6 lg:max-w-7xl gap-4
       text-slate-600 font-medium text-sm justify-center items-center">
