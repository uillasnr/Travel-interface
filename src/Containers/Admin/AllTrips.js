                ...
                Trips.map((trip) => (
                    ...
                    <div className="w-full " key={trip.id}>
                        <Link to={`/detalhes/${trip.id}`} style={{ textDecoration: 'none' }}>
                            <div className="relative h-full flex cursor-pointer bg-white gap-3 
                            m-4 drop-shadow-2xl rounded-lg transition-transform transform hover:scale-105">

                                <img src={trip.coverImage} className="rounded-lg shadow-md m-4 h-full w-[250px]"
                                ...
                                <div className="m-2">
                                    ...
                                    <p className="text-xs font-normal text-gray-600 text-center w-60 flex
                                 items-center px-2 my-1">
